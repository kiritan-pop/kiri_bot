...
KIGO_PATH = 'data/.kigo'
TAROT_DATA_PATH = "./data/tarot_data.json"
TAROT_IMG_PATH = "./data/tarot_img/"
TAROT_CHK_PATH = "./data/tarot_chk.json"
TAROT_IMGMAP_PATH = "./data/tarot_imgmap.json"
# FONT_PATH = 'ipaexg.ttf'
FONT_PATH = '07やさしさゴシック.ttf'
